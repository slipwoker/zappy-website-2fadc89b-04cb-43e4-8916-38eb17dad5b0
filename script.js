document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
        ...
        fetch(action, {
          ...
          .then(function (response) {
            if (response.ok) {
              ...
              handleFormError(submitBtn, originalText);
            }
          })
          .catch(function () {
            handleFormError(submitBtn, originalText);
    ...
    function handleFormError(submitBtn, originalText) {
      if (submitBtn) {
        submitBtn.disabled = false;
        submitBtn.textContent = originalText;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פאפ טאקוס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2fadc89b-04cb-43e4-8916-38eb17dad5b0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2fadc89b-04cb-43e4-8916-38eb17dad5b0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2fadc89b-04cb-43e4-8916-38eb17dad5b0';
